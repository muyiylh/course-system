var setupMenuEvents = function() {
    ...
    $(document).on('touchstart mousedown', '#superscriptAndSubscript01Button', function (e) {
        e.preventDefault();
        e.stopPropagation();
        var equation = getEquation();
        var superscriptAndSubscriptWrapper = new eqEd.SuperscriptAndSubscriptWrapper(equation,"subtype");
        insertWrapper(superscriptAndSubscriptWrapper);
    });
    ...
    //ggy
    $(document).on('touchstart mousedown', '#leftParenthesisBracketButton', function (e) {
        /*e.preventDefault();
        e.stopPropagation();
        var equation = getEquation();
        var leftParenthesisBracketWrapper = new eqEd.BracketWrapper(equation, "leftParenthesisBracket");
        insertWrapper(leftParenthesisBracketWrapper);*/
    	 e.preventDefault();
         e.stopPropagation();
         var equation = getEquation();
         var parenthesesBracketPair = new eqEd.BracketPairWrapper(equation, "parenthesisBracketLeft");
         insertWrapper(parenthesesBracketPair);
    });
    $(document).on('touchstart mousedown', '#rightParenthesisBracketButton', function (e) {
        /*e.preventDefault();
        e.stopPropagation();
        var equation = getEquation();
        var rightParenthesisBracketWrapper = new eqEd.BracketWrapper(equation, "rightParenthesisBracket");
        insertWrapper(rightParenthesisBracketWrapper);*/
    	e.preventDefault();
        e.stopPropagation();
        var equation = getEquation();
        var parenthesesBracketPair = new eqEd.BracketPairWrapper(equation, "parenthesisBracketRight");
        insertWrapper(parenthesesBracketPair);
    });
    $(document).on('touchstart mousedown', '#leftSquareBracketButton', function (e) {
        /*e.preventDefault();
        e.stopPropagation();
        var equation = getEquation();
        var leftSquareBracketWrapper = new eqEd.BracketWrapper(equation, "leftSquareBracket");
        insertWrapper(leftSquareBracketWrapper);*/
    	e.preventDefault();
        e.stopPropagation();
        var equation = getEquation();
        var squareBracketPair = new eqEd.BracketPairWrapper(equation, "squareBracketLeft");
        insertWrapper(squareBracketPair);
    });
    $(document).on('touchstart mousedown', '#rightSquareBracketButton', function (e) {
       /* e.preventDefault();
        e.stopPropagation();
        var equation = getEquation();
        var rightSquareBracketWrapper = new eqEd.BracketWrapper(equation, "rightSquareBracket");
        insertWrapper(rightSquareBracketWrapper);*/
    	e.preventDefault();
        e.stopPropagation();
        var equation = getEquation();
        var squareBracketPair = new eqEd.BracketPairWrapper(equation, "squareBracketRight");
        insertWrapper(squareBracketPair);
    });
    $(document).on('touchstart mousedown', '#leftCurlyBracketButton', function (e) {
        /*e.preventDefault();
        e.stopPropagation();
        var equation = getEquation();
        var leftCurlyBracketWrapper = new eqEd.BracketWrapper(equation, "leftCurlyBracket");
        insertWrapper(leftCurlyBracketWrapper);*/
    	e.preventDefault();
        e.stopPropagation();
        var equation = getEquation();
        var curlyBracketPair = new eqEd.BracketPairWrapper(equation, "curlyBracketLeft");
        insertWrapper(curlyBracketPair);
    });
    $(document).on('touchstart mousedown', '#rightCurlyBracketButton', function (e) {
        /*e.preventDefault();
        e.stopPropagation();
        var equation = getEquation();
        var rightCurlyBracketWrapper = new eqEd.BracketWrapper(equation, "rightCurlyBracket");
        insertWrapper(rightCurlyBracketWrapper);*/
    	e.preventDefault();
        e.stopPropagation();
        var equation = getEquation();
        var curlyBracketPair = new eqEd.BracketPairWrapper(equation, "curlyBracketRight");
        insertWrapper(curlyBracketPair);
    });
    ...
    $(document).on('touchstart mousedown', '#limLowerButton', function (e) {
        e.preventDefault();
        e.stopPropagation();
        var equation = getEquation();
        var functionWrapper = new eqEd.FunctionLowerWrapper(equation, 'lim', "MathJax_Main");
        insertWrapper(functionWrapper);
    });
    ...
    $(document).on('touchstart mousedown', '#wanAccentButton', function (e) {
        e.preventDefault();
        e.stopPropagation();
        var equation = getEquation();
        var accentWrapper = new eqEd.AccentWrapper(equation, '~', 'MathJax_Main');
    ...
    $(document).on('touchstart mousedown', '#gaiAccentButton', function (e) {
        e.preventDefault();
        e.stopPropagation();
        var equation = getEquation();
        var accentWrapper = new eqEd.AccentWrapper(equation, '⌒', 'MathJax_Main');
    ...
    $(document).on('touchstart mousedown', '#douhaoButton', function (e) {
        e.preventDefault();
        e.stopPropagation();
        var equation = getEquation();
    ...
    $(document).on('touchstart mousedown', '#chengfaButton', function (e) {
        e.preventDefault();
        e.stopPropagation();
        var equation = getEquation();
        var operatorWrapper = new eqEd.OperatorWrapper(equation, '∗', "MathJax_Main");
    ...
    $(document).on('touchstart mousedown', '#jiantouButton', function (e) {
        e.preventDefault();
        e.stopPropagation();
        var equation = getEquation();
        var operatorWrapper = new eqEd.OperatorWrapper(equation, '→', "MathJax_Main");
    ...
    $(document).on('touchstart mousedown', '#chuButton', function (e) {
        e.preventDefault();
        e.stopPropagation();
        var equation = getEquation();
        var operatorWrapper = new eqEd.OperatorWrapper(equation, '/', "MathJax_Main");
    ...
    $(document).on('touchstart mousedown', '#sssButton', function (e) {
        e.preventDefault();
        e.stopPropagation();
        var equation = getEquation();
        var operatorWrapper = new eqEd.OperatorWrapper(equation, '∠', "MathJax_Main");
