eqEd.BracketPairWrapper = function(equation, bracketType) {
    ...
    var bracketCtors = {
        ...
        "parenthesisBracketLeft": {
            'left': eqEd.LeftParenthesisBracket,
            'right': eqEd.RightParenthesisBracket
        },
        "parenthesisBracketRight": {
            'left': eqEd.LeftParenthesisBracket,
            'right': eqEd.RightParenthesisBracket
        },
        "squareBracket": {
    ...
    if(bracketType == "parenthesisBracketLeft"||bracketType == "squareBracketLeft"||bracketType == "curlyBracketLeft"){
    	this.leftBracket = new bracketCtors[bracketType]['left'](this);
    }else if(bracketType == "parenthesisBracketRight"||bracketType == "squareBracketRight"||bracketType == "curlyBracketRight"){
    ...
    if(bracketType == "parenthesisBracketLeft"||bracketType == "squareBracketLeft"||bracketType == "curlyBracketLeft"){
    	this.childNoncontainers = [this.leftBracket];
    }else if(bracketType == "parenthesisBracketRight"||bracketType == "squareBracketRight"||bracketType == "curlyBracketRight"){
    	this.childNoncontainers = [this.rightBracket];
    }else{
    ...
    this.properties.push(new Property(this, "width", width, {
        ...
        compute: function() {
        	if(bracketType == "parenthesisBracketLeft"||bracketType == "squareBracketLeft"||bracketType == "curlyBracketLeft"){
        		return this.leftBracket.width + this.bracketContainer.width;
            }else if(bracketType == "parenthesisBracketRight"||bracketType == "squareBracketRight"||bracketType == "curlyBracketRight"){
            	return this.bracketContainer.width + this.rightBracket.width;
            }else{
    ...
    this.properties.push(new Property(this, "topAlign", topAlign, {
        ...
        compute: function() {
            ...
            if (this.bracketContainer.wrappers.length > 0) {
                ...
                var bracketTopAlign = 0;
                if(bracketType == "parenthesisBracketRight"||bracketType == "squareBracketRight"||bracketType == "curlyBracketRight"){
                	bracketTopAlign = 0.5 * this.rightBracket.height;
                }else{
                	bracketTopAlign = 0.5 * this.leftBracket.height;
                }
    ...
    this.properties.push(new Property(this, "bottomAlign", bottomAlign, {
        ...
        compute: function() {
            ...
            if (this.bracketContainer.wrappers.length > 0) {
                ...
                var bracketBottomAlign = 0;
                if(bracketType == "parenthesisBracketRight"||bracketType == "squareBracketRight"||bracketType == "curlyBracketRight"){
                	bracketBottomAlign = 0.5 * this.rightBracket.height;
                }else{
                	bracketBottomAlign = 0.5 * this.leftBracket.height;
                }
