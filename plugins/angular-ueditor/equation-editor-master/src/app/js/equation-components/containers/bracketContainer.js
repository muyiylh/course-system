eqEd.BracketContainer = function(parent) {
    ...
    this.properties.push(new Property(this, "left", left, {
        ...
        compute: function() {
        	if(this.parent.leftBracket==undefined){
        		return 0;
        	}else{
        ...
        compute: function() {
            ...
            if (this.wrappers.length > 0) {
                ...
                */
                ...
                var bracketTopAlign = 0;//0.5 * this.parent.leftBracket.height;
                if(this.parent.leftBracket==undefined){
                	bracketTopAlign = 0.5 * this.parent.rightBracket.height;
            	}else{
            		bracketTopAlign = 0.5 * this.parent.leftBracket.height;
            	}
